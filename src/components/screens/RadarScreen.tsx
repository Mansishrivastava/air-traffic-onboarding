...
const RadarScreen: React.FC = () => (
  <div style={{ display: 'flex', minHeight: '100vh', background: '#F8F8F8' }}>
    ...
    <main style={{ flex: 1, padding: '3rem 4rem', position: 'relative' }}>
      ...
      <div style={{ fontSize: 32, fontWeight: 900, fontFamily: 'serif', marginBottom: 16 }}>Welcome Katie!</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 24, marginBottom: 32 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: 32, boxShadow: '0 1px 8px rgba(0,0,0,0.03)', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 8 }}>
          <span style={{ background: '#E8F5E9', color: '#43A047', fontWeight: 700, borderRadius: 8, padding: '2px 10px', fontSize: 16, marginBottom: 8 }}>+16%</span>
          <span style={{ fontSize: 48, fontWeight: 900, fontFamily: 'serif' }}>140</span>
          <span style={{ color: '#888', fontWeight: 500, fontSize: 16 }}>New personalized engagements</span>
        </div>
        <div style={{ background: '#fff', borderRadius: 20, padding: 32, boxShadow: '0 1px 8px rgba(0,0,0,0.03)', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 8 }}>
          <span style={{ background: '#FFEBEE', color: '#E53935', fontWeight: 700, borderRadius: 8, padding: '2px 10px', fontSize: 16, marginBottom: 8 }}>-4%</span>
          <span style={{ fontSize: 48, fontWeight: 900, fontFamily: 'serif' }}>120%</span>
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: 32, boxShadow: '0 1px 8px rgba(0,0,0,0.03)', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 8 }}>
          <span style={{ background: '#E8F5E9', color: '#43A047', fontWeight: 700, borderRadius: 8, padding: '2px 10px', fontSize: 16, marginBottom: 8 }}>B+</span>
          <span style={{ fontSize: 48, fontWeight: 900, fontFamily: 'serif' }}>B+</span>
        ...
        <div style={{ background: '#fff', borderRadius: 20, padding: 32, boxShadow: '0 1px 8px rgba(0,0,0,0.03)', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 8 }}>
          <span style={{ background: '#FFEBEE', color: '#E53935', fontWeight: 700, borderRadius: 8, padding: '2px 10px', fontSize: 16, marginBottom: 8 }}>-4%</span>
          <span style={{ fontSize: 48, fontWeight: 900, fontFamily: 'serif' }}>$10K</span>
